...
void Merge(double *arr, int first_index, int middle_index, int last_index);
void MergeSort(double *arr, int index1, int index2);
...
void Merge(double *arr, int first_index, int middle_index, int last_index) {
    ...
    double *left = (double*)malloc(len1 * sizeof(double));
    double *right = (double*)malloc(len2 * sizeof(double));
    for (i = 0; i < len1; i++)
